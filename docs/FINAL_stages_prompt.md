# FINAL Stages Table Prompt - Output Format Fixed

## Deploy this to Stages.record_audit (lines 3-290)
...
3. stage_id missing/invalid? → -50 points
...
- Should reference BQX windows: [45, 90, 180, 360, 720, 1440, 2880]
...
6. ✓ I looked for stage_id (NOT task_id)
