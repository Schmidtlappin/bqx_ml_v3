# Simple Stages Prompt - Minimal Version with Remediation

## Deploy lines 5-150 to Stages.record_audit

```
Score the quality of this Stages table record.
...
"CRITICAL: Add description (100+ chars). Include what this stage accomplishes, methods used, and expected outcomes. This caps score at 55."
...
1. Copy lines 5-150
2. Paste into Stages table → record_audit field → Configure AI
