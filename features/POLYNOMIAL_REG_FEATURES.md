...
| Column | Type | Description | Formula |
|--------|------|-------------|---------|
| `reg_r2_{W}` | FLOAT64 | R² score [0,1] | `1 - SS_res / SS_tot` |
| `reg_rmse_{W}` | FLOAT64 | Root mean squared error | `sqrt(mean(residuals²))` |
...
SELECT
  ...
  1 - ss_res / NULLIF(ss_tot, 0) as reg_r2_{W},
  SQRT(ss_res / W) as reg_rmse_{W},
